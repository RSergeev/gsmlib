...
pkgdatadir = $(datadir)/gsmlib
pkglibdir = $(libdir)/gsmlib
pkgincludedir = $(includedir)/gsmlib

top_builddir = .

ACLOCAL = ${SHELL} /Users/roman/projects/gsmlib/scripts/missing --run aclocal-1.9
AUTOCONF = ${SHELL} /Users/roman/projects/gsmlib/scripts/missing --run autoconf
AUTOMAKE = ${SHELL} /Users/roman/projects/gsmlib/scripts/missing --run automake-1.9
AUTOHEADER = ${SHELL} /Users/roman/projects/gsmlib/scripts/missing --run autoheader
...
POST_UNINSTALL = :
host_alias = 
host_triplet = arm-apple-darwin24.6.0
AR = ar
AS = @AS@
...
MAKEINFO = ${SHELL} /Users/roman/projects/gsmlib/scripts/missing --run makeinfo
